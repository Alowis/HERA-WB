...
dis_map1 <- build_map_dis(make_dis_sf(dis_daily),make_dis_sf(dis_daily[which(dis_daily$match_type=="strict"),]), "Daily")
dis_map2 <- build_map_dis(make_dis_sf(dis_7d),make_dis_sf(dis_7d[which(dis_7d$match_type=="strict"),]), "7-Day")
...
swe_map3 <- build_map(make_swe_sf(swe_15d), "15-Day")
...
ggsave(file.path(path_out, "Fig_SWE_discharge_combined_v4.png"), fig_combined,
